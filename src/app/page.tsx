  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16 sm:py-20">
      ...
      <div className="mt-12 space-y-6 sm:space-y-5">
        <WordReveal text="좋은 서비스는 잘 짠 코드가 아니라, 제대로 짚은 문제에서 시작한다고 믿습니다." />
        ...
        <WordReveal text="그 생각 하나로 강동구 수어통역센터의 문을 두드렸습니다. 약속도 없이 확신만 들고 찾아간 자리였습니다. 낯선 곳에 불쑥 찾아가 다짜고짜 궁금한 걸 묻는 게 편하지만은 않았습니다. 그래도 통역사님은 시간을 내주셨습니다." />
        <WordReveal text="이런저런 이야기를 나누다가 제가 옳다고 믿었던 걸 흔드는 이야기를 들었습니다. 한국수어를 제1언어로 쓰는 일부 농인분들에게는 한국어 자막의 어순과 문장 구조가 낯설어서 자막이 있어도 이해가 어려울 수 있다는 설명이었습니다." />
        <WordReveal text="자막이 있는데 이해가 어렵다는 게 처음엔 잘 와닿지 않았습니다. 한국수어가 모국어이고 한국어는 그다음에 배우는 언어인 분들이 있다는 걸 그때 처음 알았습니다. 제가 맞다고 믿었던 전제 자체가 틀렸던 겁니다. 이상하게도 실망스럽지 않았습니다. 확신이 아니라 질문에서 다시 시작해야 한다는 걸 그 자리에서 배웠습니다." />
